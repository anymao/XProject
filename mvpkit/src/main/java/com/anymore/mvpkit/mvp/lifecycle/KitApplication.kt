package com.anymore.mvpkit.mvp.lifecycle

import android.app.Activity
import android.app.Application
import android.content.Context
import android.support.v4.app.Fragment
import com.anymore.mvpkit.di.component.DaggerKitComponent
import com.anymore.mvpkit.mvp.lifecycle.application.ApplicationWrapper
...
open class KitApplication:Application(),HasActivityInjector,HasSupportFragmentInjector{
    ...
    override fun attachBaseContext(base: Context?) {
        ...
        DaggerKitComponent.create().inject(this)
