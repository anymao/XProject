package com.anymore.example.app.delegates
...
class SharedPreferenceHelper(private val spName: String = "default") {
    private val application by lazy { ExampleApplication.INSTANCE }
    ...
    fun getStings(name: String, default: Set<String> = emptySet()):Set<String> = sharedPreferences.getStringSet(name,default)
}